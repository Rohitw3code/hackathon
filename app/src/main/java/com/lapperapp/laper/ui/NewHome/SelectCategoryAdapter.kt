...
class SelectCategoryAdapter(private val mList: List<SelectCategorymodel>,val keys:MutableList<SelectCategorymodel>) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            if (holder.clicked){
                ...
                ViewCompat.setBackgroundTintList(holder.bg, ColorStateList.valueOf(ContextCompat.getColor(holder.itemView.context, R.color.green)))
            }
        }
